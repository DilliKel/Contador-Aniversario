...
let countDate = new Date("may 27, 2023 00:00:00").getTime()

let x = setInterval( () => {
    let now = new Date().getTime()

    // Distancia entre a data linkada e o dia de hoje
    ...
    // Criação das variáveis e calculo dos dias
    ...
    // Acrescentando das variáveis ao HTML
    Tdias.innerHTML = dia
